    ...
    <section id="hero" ref={ref} className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 w-full">
        ...
        >
          <a
            href="#projects"
            className="group relative isolate inline-flex items-center gap-2 overflow-hidden rounded-xl bg-gradient-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-glow transition-all duration-150"
          >
            <span
              aria-hidden="true"
              className="absolute inset-0 bg-[linear-gradient(135deg,oklch(0.82_0.18_200),oklch(0.70_0.20_305),oklch(0.76_0.18_160),oklch(0.78_0.16_220),oklch(0.82_0.18_200))] opacity-0 transition-opacity duration-150 group-hover:opacity-100"
            />
            <span
              aria-hidden="true"
              className="absolute -inset-1 bg-[linear-gradient(135deg,oklch(0.82_0.18_200/.45),oklch(0.70_0.20_305/.7),oklch(0.76_0.18_160/.55),oklch(0.78_0.16_220/.65),oklch(0.82_0.18_200/.45))] opacity-0 blur-xl transition-opacity duration-150 group-hover:opacity-80"
            />
